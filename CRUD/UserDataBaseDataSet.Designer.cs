...
namespace CRUD.UserDataBaseDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([Id] = @Original_Id) AND ([Username] = @Original" +
                "_Username) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Username], [Password], [Email]) VALUES (@Username, @Pa" +
                "ssword, @Email);\r\nSELECT Id, Username, Password, Email FROM [User] WHERE (Id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [Username] = @Username, [Password] = @Password, [Email] = @Email WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email));
SELECT Id, Username, Password, Email FROM [User] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(LocalDB)\\v11.0;AttachDbFilename=|DataDirectory|\\UserDataBase.mdf;Int" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, Email FROM dbo.[User]";
