...
namespace WindowsFormsApplication1.Database11DataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `username` = ?, `password` = ?, `email` = ? WHERE ((`ID` = ?) " +
                "AND ((? = 1 AND `username` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `passwo" +
                "rd` IS NULL) OR (`password` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` =" +
                " ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.Database11ConnectionString;
        }
        ...
        public virtual int Fill(Database11DataSet.usersDataTable dataTable) {
        ...
        public virtual Database11DataSet.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database11DataSet.usersDataTable dataTable = new Database11DataSet.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database11DataSet.usersDataTable dataTable) {
