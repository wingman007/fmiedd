...
namespace WindowsFormsApplication1 {
    ...
    public partial class db1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string FirstName, string LastName, string EmailAddress, string Nationality) {
...
namespace WindowsFormsApplication1.db1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Users` WHERE ((`UsersID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `EmailAddress` IS NULL) OR (`EmailAddress` = ?)) AND ((? = 1 AND `Nationality` IS NULL) OR (`Nationality` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_UsersID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UsersID", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`FirstName`, `LastName`, `EmailAddress`, `Nationality`) VALU" +
                "ES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Users` SET `FirstName` = ?, `LastName` = ?, `EmailAddress` = ?, `Nationality` = ? WHERE ((`UsersID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `EmailAddress` IS NULL) OR (`EmailAddress` = ?)) AND ((? = 1 AND `Nationality` IS NULL) OR (`Nationality` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_UsersID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "UsersID", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.db1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UsersID, FirstName, LastName, EmailAddress, Nationality FROM Users";
        ...
        public virtual int Delete(int Original_UsersID, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_Nationality) {
        ...
        public virtual int Insert(string FirstName, string LastName, string EmailAddress, string Nationality) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string EmailAddress, string Nationality, int Original_UsersID, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_Nationality) {
            if ((FirstName == null)) {
