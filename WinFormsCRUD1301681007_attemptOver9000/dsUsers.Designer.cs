...
namespace WinFormsCRUD1301681007_attemptOver9000 {
    ...
    public partial class dsUsers : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(string username, string password, string first_name, string last_name, string role) {
...
namespace WinFormsCRUD1301681007_attemptOver9000.dsUsersTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [users] ([username], [password], [first_name], [last_name], [role]) V" +
                "ALUES (@username, @password, @first_name, @last_name, @role)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [users] SET [username] = @username, [password] = @password, [first_name] =" +
                " @first_name, [last_name] = @last_name, [role] = @role WHERE (([id] = @Original_" +
                "id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinFormsCRUD1301681007_attemptOver9000.Properties.Settings.Default.dataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [id], [username], [password], [first_name], [last_name], [role] FROM [user" +
                "s]";
        ...
        public virtual int Fill(dsUsers.usersDataTable dataTable) {
        ...
        public virtual dsUsers.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsUsers.usersDataTable dataTable = new dsUsers.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsUsers.usersDataTable dataTable) {
        ...
        public virtual int Insert(string username, string password, string first_name, string last_name, string role) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string first_name, string last_name, string role, int Original_id) {
            if ((username == null)) {
