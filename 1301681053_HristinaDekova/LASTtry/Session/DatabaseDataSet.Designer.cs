...
namespace Session {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TusersDataTable : global::System.Data.TypedTableBase<TusersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TusersRow AddTusersRow(string Username, string Password, string email) {
        ...
        public partial class TusersRow : global::System.Data.DataRow {
            ...
            public string email {
                get {
                    try {
                        return ((string)(this[this.tableTusers.emailColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'email\' in table \'Tusers\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTusers.emailColumn] = value;
                }
            }
            ...
            public bool IsemailNull() {
                return this.IsNull(this.tableTusers.emailColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetemailNull() {
                this[this.tableTusers.emailColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Session.DatabaseDataSetTableAdapters {
    ...
    public partial class TusersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Tusers` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`U" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Tusers` (`Username`, `Password`, `email`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Tusers` SET `Username` = ?, `Password` = ?, `email` = ? WHERE ((`ID` = ?)" +
                " AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Passw" +
                "ord` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `email` IS NULL) OR (`email` " +
                "= ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Session.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, [Password], email FROM Tusers";
        ...
        public virtual int Fill(DatabaseDataSet.TusersDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.TusersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.TusersDataTable dataTable = new DatabaseDataSet.TusersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.TusersDataTable dataTable) {
