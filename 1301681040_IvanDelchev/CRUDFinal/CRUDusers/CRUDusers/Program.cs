...
namespace CRUDusers
{
    class Program
    {
        ...
        {
            aConnection = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\users.accdb");
//Data Source=C:\Users\Ivan\Desktop\CRUDusers (1)\CRUDusers\CRUDusers\data\users.accdb");
               Action(); 
